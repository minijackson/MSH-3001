...
<<know fr, echo=FALSE, fig.cap="Proportion des personnes connaissant auparavant la C4 Cactus ayant répondu au sondage français", fig.pos="H", fig.height=5>>=
legendaryPie(sondage.fr$Connaissez.vous.le.modèle.C4.Cactus..)
@

<<know en, echo=FALSE, fig.cap="Proportion des personnes connaissant auparavant la C4 Cactus ayant répondu au sondage anglais", fig.pos="H", fig.height=5>>=
